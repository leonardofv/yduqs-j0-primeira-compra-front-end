import { Box, Button, Checkbox, FormControlLabel, MenuItem, TextField, Typography, Link, FormHelperText } from "@mui/material";
        ...
        >
            ...
            <Box>
                <FormControlLabel
                    ...
                    control={<Checkbox {...register('acceptedTerms')} sx={{ p: 0, mr: '8px' }} />}
                    label={
            ...
            <FormControlLabel
                sx={{ ml: 0, alignItems: 'flex-start' }}
                control={<Checkbox {...register('whatsappOptIn')} sx={{ p: 0, mr: '8px' }} />}
                label={
                    <Typography sx={{ fontSize: '16px', fontWeight: 500, lineHeight: 1.33 }}>
